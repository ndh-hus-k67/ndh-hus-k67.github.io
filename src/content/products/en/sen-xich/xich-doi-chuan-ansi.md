...
seo:
  title: "ANSI Duplex Roller Chain - Heavy duty, high durability"
  description: "ANSI duplex roller chain for heavy-load applications. Higher capacity than single strand chain and stable operation across many sizes."
...
main:
  ...
  content: |
    ...
    Commonly used in heavy industries such as cement, mining, steel, wood processing, agriculture, and precision machinery.
    </br></br>
    Available in multiple sizes and materials (e.g., Mn40 alloy steel, SUS304 stainless steel, engineering plastic) to match different industry requirements.
...
tableData:
  - feature:
    ...
    description:
      ...
      - ["Transverse pitch (mm)", "6.4", "10.13", "11.95", "14.38", "18.11"]
  ...
  - feature:
    ...
    description:
      ...
      - ["Transverse pitch (mm)", "22.78", "29.29", "35.76", "45.44", "48.87"]
