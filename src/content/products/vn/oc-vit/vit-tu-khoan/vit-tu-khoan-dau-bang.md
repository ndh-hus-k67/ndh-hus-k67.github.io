...
main:
  id: 1
  content: |
    Vít inox tự khoan đầu bằng là một loại vít inox được sử dụng để liên kết để liên kết một vật, một kết cấu với khung thép, xà gồ…Mà trên khung hay xà gồ chưa có lỗ chờ sẵn.
